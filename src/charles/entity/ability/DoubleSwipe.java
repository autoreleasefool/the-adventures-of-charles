...
public class DoubleSwipe extends Ability {
    public DoubleSwipe (Engine engine, int x, int y, int attack, int direction) {
	//Sends these values to the super class
	super(engine, x, y, 48, 64, attack, 1, 1, direction, false, true);
    }
	...
	return (Image) (Art.abilitySheet.getSubimage((damageTimer - 30) / -6 * 32, 64, 32, 32));
    }
}
