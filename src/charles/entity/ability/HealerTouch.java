...
public class HealerTouch extends Ability {
    public HealerTouch(Engine engine, int x, int y) {
	//Sends these values to the super class
	super(engine, x, y, 16, 64, 0, 300, 0, 0, false, false);
    }
	...
	return (Image)(Art.abilitySheet.getSubimage(animFrame / 6 * 16 + 112, 0, 16, 64));
    }
    
    //Returns "active ability" icon of the ability from the spritesheet
    private Image getPassiveImage() {
	return (Image)(Art.abilitySheet.getSubimage(80, 32, 32, 32));
    }
}
