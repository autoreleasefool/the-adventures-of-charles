...
public class MagicArmor extends Ability {
    public MagicArmor(Engine engine, int x, int y, int time) {
	...
	return (Image)(Art.abilitySheet.getSubimage(animFrame / 6 * 16 + 192, 0, 16, 64));
    }
    
     //Returns "active ability" icon of the ability from the spritesheet
    private Image getPassiveImage() {
	return (Image)(Art.abilitySheet.getSubimage(352, 0, 32, 32));
    }
}
