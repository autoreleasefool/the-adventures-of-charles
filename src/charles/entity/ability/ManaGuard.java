...
public class ManaGuard extends Ability {
    public ManaGuard(Engine engine, int x, int y, int time) {
	...
	return (Image)(Art.abilitySheet.getSubimage(animFrame / 6 * 16 + 384, 0, 16, 64));
    }
    
    //Returns "active ability" icon of the ability from the spritesheet
    private Image getPassiveImage() {
	return (Image)(Art.abilitySheet.getSubimage(352, 32, 32, 32));
    }
}
