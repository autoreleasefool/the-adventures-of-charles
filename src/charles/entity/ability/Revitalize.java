...
public class Revitalize extends Ability {
    public Revitalize(Engine engine, int x, int y) {
	...
	return (Image)(Art.abilitySheet.getSubimage(animFrame / 6 * 16 + 576, 0, 16, 64));
    }
    
    //Returns "active ability" icon of the ability from the spritesheet
    private Image getPassiveImage() {
	return (Image)(Art.abilitySheet.getSubimage(544, 32, 32, 32));
    }
}
