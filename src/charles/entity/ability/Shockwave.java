...
public class Shockwave extends Ability {
    ...
    public Shockwave(Engine engine, int x, int y, int attack, int direction) {
	//Sends these values to the super class
	super(engine, x, y, 96, 64, attack, 1, 3, direction, false, true);
    }
	...
	return (Image) (Art.abilitySheet.getSubimage((damageTimer - 30) / -6 * 32 + 448, 64, 32, 32));
    }
}
